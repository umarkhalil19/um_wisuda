			  ...
			  <div class="login-box">
				  ...
				  <div class="form-group">
					<?php echo $captcha['image']; ?>
						  <?php if(form_error('userCaptcha') != ""){echo "<div class='alert alert-error'>".form_error('userCaptcha')."</div>";} ?>
				  </div>
				  <div class="form-group">
					<input class="form-control" type="number" autocomplete="off" name="userCaptcha" placeholder="Masukkan angka diatas .." value="<?php if(!empty($userCaptcha)){ echo $userCaptcha;} ?>" />
				  </div>
