            ...
            <tr>
              <td width="20%">
                ...
                <select name="thn" id="thn" class="form-control">
                  ...
                  <?php
                    $tahun1=mysqli_query($db, "SELECT YEAR(h_tanggal) FROM tbl_alumni GROUP BY YEAR(h_tanggal)");
              ...
              <a class="btn btn-outline-success" onclick="javascript:onclick=window.location = jurusan.value+thn.value+sesi.value;" title="Tampil Data"><span class="fa fa-search"></span>Tampil</a>
              </td>
              <?php /*
