...
?>
  ...
  <div class="tile col-md-4">
    ...
    <?php foreach($pesan as $d){
        ...
        //$nama = "NIM : ".$a1['peserta_kode'];

    ?>
        <div class="tile-body">
          <?php echo "NO PESERTA : ".$a1['peserta_kode']."<br>NAMA : ".$a1['peserta_nama']."<br><br>"; ?>
    ...
    <div class="tile col-md-8">
      <div class="box-inner">
        <div class="tile-body">
          <form method="post" action="<?php echo base_url().'biro/pesan_balas_act' ?>" enctype="multipart/form-data">
            <div class="form-group">
              <input type="hidden" name="uid" value="<?php echo $d->tp_id; ?>">
              <input type="hidden" name="kode" value="<?php echo $d->tp_kode; ?>">
              <input type="hidden" name="tujuan" value="<?php echo $d->tp_mahasiswa; ?>">
