<main class="app-content">
  <div class="app-title">
    <div>
      <h1><i class="fa fa-th-list"></i> Verifikasi Data Pengurusan Ijazah Mahasiswa</h1>
    </div>
  </div>
  <div class="row">
    <div class="col-md-12">
...
?>
        <form target="" action="<?php echo base_url()?>biro/peserta_ver/" method="post">
          <table width="20%">
            <tr>
              <td>
              ...
              <?php
                ...
                foreach($jurusan as $d){
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="<?php echo base_url().'biro/peserta_ver_tampil/'.$thn.$d->prodi_kode ?>" title="Lihat Data" style="text-decoration: none">
                    ...
                    <td align="center">
                      <?php //echo $rs1[0]; ?>
                      <a href="<?php echo base_url().'biro/peserta_tampil/'.$thn.$d->prodi_kode ?>" title="Lihat Data" style="text-decoration: none">
                        <?php echo $rs1[0]; ?>
                      </a>
                    </td>
                    <td align="center">
                    ...
                    <td align="center">
                      <a href="<?php echo base_url().'biro/peserta_ver_selesai/'.$thn.$d->prodi_kode ?>" title="Lihat Data" style="text-decoration: none">
                        <?php echo $rs3[0]; ?>
                      </a>
                    </td>
                    <td align="center">
                    ...
                    <td>
                      <div class="btn-group">
                        <a class="btn btn-sm btn-outline-success" href="<?php echo base_url().'biro/peserta_ver_tampil/'.$thn.$d->prodi_kode ?>" title="Lihat Data" style="text-decoration: none"><span class="glyphicon glyphicon-search"></span> Lihat</a>
                        </a>
                      </div>
                    </td>
                  </tr>
