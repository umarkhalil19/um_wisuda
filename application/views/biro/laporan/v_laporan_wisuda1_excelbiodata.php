...
<body>
	...
	echo '<tr>
						...
						<td align="center" bgcolor="BEC3C7"><b>PEMILIK REKENING</b></td>
						<td align="center" bgcolor="BEC3C7"><b>NOMOR REKENING</b></td>
						<td align="center" bgcolor="BEC3C7"><b>NAMA BANK</b></td>
					</tr>';
	foreach ($peserta as $p) {
		...
		echo '<tr>
				...
				<td align="left" valign="top">' . $p->mhs_nama_pemilik . '</td>
