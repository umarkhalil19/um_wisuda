<?php 
	...
	$pdf->SetTitle("Buku Wisuda Universitas Malikussaleh");
	...
	class MYPDF extends TCPDF {
		public function Header() {
			 ...
			 $img_file1 = base_url().'vic_image/system/logo_atas_1.jpg';
			 $this->Image($img_file1, 0, 0, 210, 15, '', '', '', false, 300, '', false, false, 0);

			 $img_file2 = base_url().'vic_image/system/logo_bawah_1.jpg';
			 $this->Image($img_file2, 0, 287, 210, 10, '', '', '', false, 300, '', false, false, 0);
	...
	foreach ($fakultas as $f1) {
		...
		//$html = '<table border="0" align="center" style="border: 1px solid black;">';
		foreach ($peserta as $p2) {
			...
			// }
			// if($gambar1 == ''){
			// 	$gambar2 = base_url().'vic_image/default/pengguna.png';
			// }else{
			// 	$gambar2 = $gambar1;
			// }
			$gambar1 = '';
			...
			if($p2->peserta_lampiran == ''){
				$gambar2 = $gambar2 = 'vic_image/default/pengguna.png';
			}else{
				$gambar2 = 'dokumen/lampiran/'.$p2->peserta_lampiran;
			}
			...
			//$pdf->Cell(0, 0, ' '.ucwords(strtolower($f1->fakultas_nama)).' Program Studi Informatika Universitas Malikussaleh', 0, 1, 'L', 0, '', 0);
			$html = '<table border="0" align="center" style="border: 2px solid lightgreen; border-spacing: 5px;">
			<tr>
				...
				<td width="80%">
					<table border="1" align="center" style="border: 1px solid black; border-spacing: 1px;">
						...
						<tr>
							...
							<td width="5%">:</td>
							<td align="left" width="60%">'.ucwords(strtolower($prodi_nama)).'</td>
						</tr>
						<tr>
	...
	$pdf->lastPage();
	$pdf->Output('Buku_Wisuda_Unimal '.$jadwal_nama.' '.$jadwal_tahun, 'I');
