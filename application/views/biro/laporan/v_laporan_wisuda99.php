<main class="app-content">
  <div class="app-title">
    <div>
      <h1><i class="fa fa-th-list"></i> Download Foto Peserta Wisuda</h1>
    </div>
  </div>
  <div class="row">
    <div class="col-md-12">
            ...
            <tbody>
              ...
              foreach ($fakultas as $f) {
                ...
                echo '<tr><td>
                        ...
                        echo '<td align="center"><a class="btn btn-sm btn-default" href="'.base_url().'zip/zip_file2/'.$sesi.$j1['prodi_kode'].'" title="Download Foto"><span class="fa fa-download"></span></a></td>';
                        echo '</tr>';
                        }
                  ...
                  echo '<tr>
                        ...
                        <tr>
                          ...
                          <td align="center" colspan="3"><b>'.$tot_j3.'</b></td>
                        </tr>
                        </table>
                      </td></tr>';
              ...
              echo '<tr>
                  ...
                  <tr>
                    <td><b>SUB TOTAL SELURUH</b></td>
                    <td align="center" colspan="3"><b>'.$tot3.' Orang</b></td>
                  </tr>
                  </table>';
                ?>
                </td>
