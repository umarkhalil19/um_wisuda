          ...
          <table class="table table-hover table-bordered" id="sampleTable">
            ...
            <tbody>
              <?php
                ...
                <tr>
                  <td><?php echo $no++; ?></td>
                  <td><?php echo $u->peserta_kode.'<br>'.$u->peserta_nama ?></td>
                  <td><?php echo $u->peserta_jenis_kelamin ?></td>
                  <td><?php echo $j[0] ?></td>
                  <td align="left">
                    <?php
                  ...
                  <td>
                    <div class="btn-group">
                      <?php
                        echo '<a class="btn btn-sm btn-outline-success" href="'.base_url().'biro/wisuda_ver_batal/'.$u->peserta_kode.$thn.$kodeprodi.'" title="Batalkan Verifikasi"><span class="fa fa-check"></span>Batalkan</a>';
                      ?>
                    </div>
                  </td>
                  <td>
