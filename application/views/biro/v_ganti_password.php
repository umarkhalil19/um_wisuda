  ...
  <div class="row" style="margin-left: 23%">
    <div class="col-md-8">
          <div class="tile">
            ...
            <div class="tile-body">
              <form method="post" action="<?php echo base_url() ?>biro/password_update" enctype="multipart/form-data">
            ...
            <div class="tile-footer">
              ...
              <a class="btn btn-danger" href="<?php echo base_url('biro') ?>"><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancel</a>
            </div>
          </div>
        </div>
  </div>
