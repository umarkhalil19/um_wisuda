<main class="app-content">
  <div class="app-title">
    ...
    <a href="<?php echo base_url('mahasiswa/pesan_add') ?>" class="btn btn-sm btn-primary pull-right"><span class="fa fa-plus"></span>Tambah Pesan</a>
  </div>
<?php show_alert(); ?>
<div class="row">
  <div class="tile col-md-12">
    ...
    <div class="tile-inner">
      ...
      <b>Semua Data Pesan </b>
          <a href="<?php echo base_url().'mahasiswa/pesan_add' ?>" class="btn btn-sm btn-success pull-right"><span class="glyphicon glyphicon-plus"></span> Kirim Pesan</a>
          <hr>
      ...
      foreach($pesan as $d){
        ...
        <tr>
          ...
          <td>
            <?php
              ...
              //if($d->tp_status_baca == 'Belum Dibaca' && $d->h_pengguna != $d->tp_mahasiswa){
                ...
                <br>
                <a style="color: red;" href="'.base_url().'mahasiswa/pesan_tampil/'.$d->tp_kode.'" title="Lihat Pesan">
                  Belum Dibaca ('.$b1[0].')
                </a>';
              }else{
                echo $d->tp_judul.$status;
          ...
          <td>
            <div class="btn-group">
              <a class="btn btn-sm btn-info btn-outline-success" href="<?php echo base_url().'mahasiswa/pesan_tampil/'.$d->tp_kode ?>" title="Lihat Pesan"><i class="app-menu__icon fa fa-search"></i>Lihat</a>
            </div>
          </td>
        </tr>
        <?php
