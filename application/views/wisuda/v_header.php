...
<head>
  ...
  <title>PENDAFTARAN WISUDA</title>
  <meta charset="utf-8">
...
<body class="app sidebar-mini rtl">
        ...
        <li class="dropdown"><a class="app-nav__item" href="#" data-toggle="dropdown" aria-label="Show notifications"><i class="<?php echo $fa; ?>"></i></a>
          <ul class="app-notification dropdown-menu dropdown-menu-right">
            ...
            while ($p = mysqli_fetch_array($pes)) {
              echo '<li><a class="app-notification__item" href="' . base_url('wisuda/pesan_tampil/' . $p['tp_kode']) . '"><span class="app-notification__icon"><span class="fa-stack fa-lg"><i class="fa fa-circle fa-stack-2x text-primary"></i><i class="fa fa-envelope fa-stack-1x fa-inverse"></i></span></span>';
              echo '<div>';
            ...
            echo '</li>';
            echo '</div>';
            echo '<li class="app-notification__footer"><a href="' . base_url() . 'wisuda/pesan">Lihat semua.</a></li>';
            ?>
          </ul>
        </li>
      <?php } ?>
  ...
  <aside class="app-sidebar">
    ...
    <ul class="app-menu">
      <li><a class="app-menu__item" href="<?php echo base_url() . 'wisuda' ?>"><i class="app-menu__icon fa fa-dashboard"></i><span class="app-menu__label">Dashboard</span></a></li>
      <?php if ($psw == 'oke') { ?>
        <li><a class="app-menu__item" href="<?php echo base_url() . 'wisuda/biodata' ?>"><i class="app-menu__icon fa fa-pencil"></i><span class="app-menu__label">Data Diri</span></a></li>
        <li><a class="app-menu__item" href="<?php echo base_url() . 'wisuda/daftarwisuda' ?>"><i class="app-menu__icon fa fa fa-pencil"></i><span class="app-menu__label">Daftar</span></a></li>
        <li><a class="app-menu__item" href="<?php echo base_url() . 'wisuda/pesan' ?>"><i class="app-menu__icon fa fa-envelope"></i><span class="app-menu__label">Pesan</span></a></li>
        <li>&nbsp;</li>
        <li><a class="app-menu__item" href="<?php echo base_url() . 'wisuda/password' ?>"><i class="app-menu__icon fa fa-key"></i><span class="app-menu__label">Ganti Password</span></a></li>
      <?php } ?>
    </ul>
  </aside>